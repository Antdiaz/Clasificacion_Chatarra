   ...
   const data58 = {
     parameters:
      '{"ClaUbicacion":' +
       ...
       + ((idmaterialviaje != 0) ? (''+config.Separador+'@pnClaArticuloRemisionado=' + idmaterialviaje +''): null)+'"}',
     tipoEstructura: 0,
   };
    ...
    if (props.NomMotivoEntrada === 3) {
      if (idmaterialr > 0) {
        callApi(urlKrakenService, 'POST', data31, (res) => {
          ...
          console.log("hola",Datosmaterial)
        });
